                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        ...
                        onChanged: (value) {
                          if (value.isNotEmpty && value.length < 25 && !isLookingLeft) {
                            addSpecificAnimationAction(controllerLookDownLeft);
                          } else if (value.isNotEmpty && value.length > 25 && !isLookingRight) {
                            addSpecificAnimationAction(controllerLookDownRight);
                          }
                        },
                      ),
                      SizedBox(
